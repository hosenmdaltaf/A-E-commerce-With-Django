...
from .views import all_products,product_details,updateItem,cart,add_product,edit_product,category,checkout
...
urlpatterns = [
    ...
    path('category/<int:pk>/', category, name='category_products'),
